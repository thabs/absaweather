...
const setForecast = (state, payload) => {
  ...
  list.forEach(element => {
    ...
    //! Not really sure why API returns multiple values for a day. For now I will only save 1st value for each day
    //! Not really best way of checking, still doing investigation on why there is more than 1 data per day
    if (day !== lastDay) {
